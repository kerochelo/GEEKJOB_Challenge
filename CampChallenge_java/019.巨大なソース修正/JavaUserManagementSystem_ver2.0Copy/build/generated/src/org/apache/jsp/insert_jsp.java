...
public final class insert_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    hs.invalidate();
      ...
      out.write("        名前:\n");
      out.write("        <input type=\"text\" name=\"name\" placeholder=\"例) 桃浦 金太郎\" value=\"");
...
if(reinput && udb.getType() == i){out.print("checked = \"checked\"");}
      ...
      out.write("        <br>\n");
      out.write("\n");
      out.write("        電話番号(半角数字と,'-'で区切って記入):\n");
      out.write("        <br>\n");
      out.write("        <input type=\"text\" name=\"tell\" placeholder=\"例) 090-1234-5678\" pattern=\"\\d{2,4}-\\d{3,4}-\\d{3,4}\" value=\"");
 if(reinput){out.print(udb.getTell());}
      ...
      out.write("        自己紹介文\n");
      out.write("        <br>\n");
      out.write("        <textarea name=\"comment\" rows=10 cols=50 style=\"resize:none\" wrap=\"hard\" placeholder=\"例) hello java\">");
