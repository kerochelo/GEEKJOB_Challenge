    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                db_st.setInt(1, 6);
                db_st.setString(2, "田中角栄");
                db_st.setString(3, "999-9999-9999");
                db_st.setInt(4, 99);
                db_st.setString(5, "1918-05-04");
                
                int db_newData = db_st.executeUpdate();
                
                out.println(db_newData); //1
            ...
            catch(ClassNotFoundException | InstantiationException | IllegalAccessException e_cnf){
                out.print("エラーが発生しました。" + e_cnf.toString());
            }
            finally{
                if(db_con != null){
                    try{
