...
if(udbs.getTypeNum() == 1 || udbs.getTypeNum() == 0){out.print("checked");}
      out.write(">エンジニア<br>\n");
      out.write("        <input type=\"radio\" name=\"type\" value=\"2\"");
if(udbs.getTypeNum() == 2){out.print("checked");}
      out.write(">営業<br>\n");
      out.write("        <input type=\"radio\" name=\"type\" value=\"3\"");
if(udbs.getTypeNum() == 3){out.print("checked");}
      out.write(">その他<br>\n");
      out.write("        <br>\n");
      out.write("\n");
      out.write("        電話番号(半角数字と,'-'で区切って記入):<br>\n");
      out.write("        <input type=\"text\" name=\"tell\" value=\"");
      out.print(udbs.getTell());
      out.write("\" pattern=\"\\d{2,4}-\\d{3,4}-\\d{3,4}\">\n");
      out.write("        <br><br>\n");
      out.write("\n");
      out.write("        自己紹介文\n");
      out.write("        <br>\n");
